...
### Home Page
![Home](src/output-images/home.png)

### Products Page
![Products](src/output-images/products.png)

### Product Detail
![Product Detail](src/output-images/product-detail.png)

### Cart
![Cart](src/output-images/cart.png)

### Checkout
![Checkout](src/output-images/checkout.png)

### Authentication
**Login:**
![Login](src/output-images/login.png)

**Register:**
![Register](src/output-images/register.png)
