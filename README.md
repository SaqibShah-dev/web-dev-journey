...
**[Γ¡É Star this repository](https://github.com/SaqibShah-dev/web-dev-journey)** ┬╖ [Quick Start](#-quick-start) ┬╖ [Roadmap](#%EF%B8%8F-suggested-learning-path) ┬╖ [Curriculum](#-curriculum) ┬╖ [Projects](#-mini-projects) ┬╖ [FAQ](#-faq)
...
| :--- | :--- |
| **Brand new to coding** | [Quick Start](#-quick-start) Γ₧ö Start with [`HTML/TextTags.html`](./HTML/TextTags.html) |
...
1. Install **Live Server** in VS Code (`Ctrl + Shift + X` Γ₧ö search and install "Live Server").
2. Open [`HTML/TextTags.html`](./HTML/TextTags.html).
3. Right-click inside the editor Γ₧ö click **Open with Live Server**.
...
| **Positioning** | [Positioning Types](./CSS/Positioning%20Types/) | [Task1ΓÇöBadge-on-Icon.html](./CSS/Positioning%20Types/Task1ΓÇöBadge-on-Icon.html) ┬╖ [Modal.html](./CSS/Positioning%20Types/Modal.html) ┬╖ Sticky Navbars |
| **Responsive Design**| [Responsive design](./CSS/Responsive%20design/) | Media queries ┬╖ [Task1ΓÇöFluid-Typography.html](./CSS/Responsive%20design/Task1ΓÇöFluid-Typography.html) ┬╖ Mobile-first rules |
...
- [Anchor-positioning-template.html](./CSS/Anchor-Positioning/Anchor-positioning-template.html) ΓÇö Configuring modern overlays and tooltips via CSS standard `anchor-name` attributes.
- [floating-example.html](./CSS/Floating_label/floating-example.html) ΓÇö Building interactive, animated form inputs with floating labels entirely in CSS.
...
### Documentation
- [MDN Web Docs](https://developer.mozilla.org/) ΓÇö Authoritative HTML/CSS/JS documentation.
- [web.dev](https://web.dev/) ΓÇö Google's guidelines for performance and accessibility rules.
- [React Dev Documentation](https://react.dev/) ΓÇö The updated documentation for contemporary hooks.
- [Can I Use](https://caniuse.com/) ΓÇö Browser compatibility verification for advanced properties.

### Styling & Tools
- [CSS-Tricks Flexbox Guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) ΓÇö Outstanding visual layout guides.
- [CSS-Tricks Grid Guide](https://css-tricks.com/snippets/css/complete-guide-grid/) ΓÇö Complete layout structure reference maps.
- [Figma](https://www.figma.com/) ΓÇö Free tool for designing UI mockups.
